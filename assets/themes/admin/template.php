...
<head>
    ...
    <![endif]-->
<input type="hidden" id="csrf_hash" value="<?=$this->csrf_hash;?>">
<input type="hidden" id="csrf_token" value="<?=$this->csrf_token;?>">
</head>
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown<?php echo (strstr(uri_string(), 'admin/post')) ? ' active' : ''; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo lang('admin button post'); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/post') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/post'); ?>"><?php echo lang('admin button post_list'); ?></a></li>
                            <li class="<?php echo (uri_string() == 'admin/post/form') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/post/form'); ?>"><?php echo lang('admin button post_add'); ?></a></li>
                        </ul>
                    </li>
                    <li class="dropdown<?php echo (strstr(uri_string(), 'admin/page')) ? ' active' : ''; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo lang('admin button page'); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/page') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/page'); ?>"><?php echo lang('admin button page_list'); ?></a></li>
                            <li class="<?php echo (uri_string() == 'admin/page/form') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/page/form'); ?>"><?php echo lang('admin button page_add'); ?></a></li>
                        </ul>
                    </li>
